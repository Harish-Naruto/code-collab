...
import { Code, Zap, Shield, Star, ChevronDown } from "lucide-react";
              ...
              <div className="flex justify-center items-center gap-2">
                <div className="flex items-center gap-1 rounded-lg px-2 sm:px-2 md:px-3 py-0.5 sm:py-1 md:py-2 justify-center">
                  ...
                  <RotatingText
                    ...
                    mainClassName="px-2 sm:px-2 md:px-3 bg-gradient-to-r from-purple-400 via-pink-500 to-purple-600 text-black overflow-hidden py-0.5 sm:py-1 md:py-2 justify-center rounded-lg"
                    staggerFrom="last"
                    initial={{ y: "100%" }}
                    animate={{ y: 0 }}
                    exit={{ y: "-120%" }}
          ...
          <Card className="bg-gray-900/90 backdrop-blur-md border-gray-700 overflow-hidden">
            ...
            <CardContent className="p-0 font-mono text-sm">
              <div className="space-y-2">
                ...
                <div className="text-green-400 ml-12">
                  {'<section className="section">'}
                </div>
                <div className="text-green-400 ml-16">
      ...
      <section id="platform" className="py-20 bg-black">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <SplitText
              text="Everything You Need to Teach Code"
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto animate-fade-in-up animation-delay-200">
              ...
              support you need to deliver world-class computer science
              education.
            </p>
          </div>
            ...
            {[
              {
                ...
                description:
                  "Students can work together on projects with live code sharing and pair programming.",
              ...
              },
              {
                ...
                description:
                  "Browser-based coding environment with real-time collaboration and instant feedback.",
              ...
              },
              {
                ...
                description:
                  "Secure, monitored platform designed specifically for educational use.",
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <p className="text-gray-400 text-lg mb-6">
            Write, run, & debug code in any web browser, no account or downloads
            needed.
          </p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-400 mb-8 animate-fade-in-up animation-delay-200">
              Get the latest updates on new features, curriculum, and
